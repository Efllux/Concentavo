...
Browser regression, encryption/tamper and macOS Electron smoke tests pass locally. Both reported private scores import and render in the new interface. Native Windows installation, fresh macOS installation, and real GitHub publishing still need release verification. Publishing tests currently use mocks.
